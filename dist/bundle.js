(function (global, factory) {
    ...
    (global = global || self, global.crc16xmodem = factory());
}(this, (function () { 'use strict';

    /**
     * CRC16 xmodem hash calculator + validator
     * 
     * Main code :: CRC16 from pycrc16 - crc16pure.py
     * Ref # https://github.com/gtrafimenkov/pycrc16/blob/master/python2x/crc16/crc16pure.py
     */
    ...
    var index = {
        /**
         * crc same usage as pycrc16 - crc16pure.py
         */
        crc16,
        /**
         * calculateChecksum
         ...
         */
        calculateChecksum(data, checkSumBit = 16) {
         ...
         * @param {Number} checksumBit Default to 16 bit transform checksum
         */
        validateChecksum(str, checksumBit = 16) {
